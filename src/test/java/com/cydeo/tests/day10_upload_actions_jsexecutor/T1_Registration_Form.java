...
//12. Select Job Title
        ...
        departmentDropdown.selectByIndex(faker.number().numberBetween(1,8));
...
//13. Select programming language from checkboxes
        ...
        //displayed.
        WebElement successfulMessage = Driver.getDriver().findElement(By.xpath("//p"));

        Assert.assertEquals(successfulMessage.getText(), "You've successfully completed registration!");
//
//
//Note:
